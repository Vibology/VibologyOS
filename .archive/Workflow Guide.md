---
tags: [system, workflow, guide, archived]
date_created: 2026-01-08
date_archived: 2026-01-19
status: deprecated
superseded_by: CLAUDE.md (Section 4), individual protocols
---

> **ARCHIVED DOCUMENT**
> This document was deprecated on 2026-01-19. Its content is now outdated:
> - References "Master Index" which no longer exists
> - Session protocol superseded by CLAUDE.md Section 1
> - Fetch → Refine → Commit cycle now documented in CLAUDE.md Section 4
> - For current procedures, see: CLAUDE.md, PROTOCOL files, GUIDE - Synthesis Quick Start.md

# Workflow Guide: The Streamlined Process (ARCHIVED)
