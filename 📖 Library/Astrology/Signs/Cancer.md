...
- Emotional manipulation (guilt as control)
- The [[Shadow]] of the Devouring Mother: love that suffocates rather than liberates

The Cancer journey is learning that *safety* is not the same as *stagnation*—that eventually, the child must leave the womb ([[Capricorn]]) and build its own authority.
...
- **[[Tarot]]:** The Chariot (Key VII) — Mastery through emotional containment, the armored heart
- **[[The Window]]:** One with Nature (contemporary face: the environmentalist, the homemaker)
- **[[Jungian Archetypes]]:** The Great Mother, The Child
