...
**Pillar 2 of 7** — The language of planetary timing and cosmic positioning.
...
### Modern Psychological Astrology (20th-21st Century)
- **Influences:** Carl Jung, Dane Rudhyar, Liz Greene, Stephen Arroyo
- **Innovations:** Outer planets (Uranus, Neptune, Pluto) as generational markers, focus on psychological growth and individuation, softer determinism (chart as potential, not fate)
...
Astrology operates through **networks of analogy and resonance**. Each planet, sign, and house is not an isolated symbol but a **node in a cosmic web** that links:

- **Mythology** (Mars = Ares, god of war)
- **Elements** (Mars = hot and dry, ruled by Fire)
- **Body Parts** (Mars = head, muscles, blood, adrenal glands)
- **Psychological Functions** (Mars = assertion, desire, anger, courage)
- **Life Domains** (Mars in 10th = career drive; Mars in 7th = attraction to assertive partners)
- **Human Design** (Mars gates in the bodygraph correlate with Martian themes)
- **Tarot** (The Tower = Martial disruption; Five of Wands = Martial competition)
- **Qabalah** (Mars = Geburah, the fifth Sephirah, severity and strength)

When synthesizing across systems, astrology provides the **temporal and ambient coordinate**—the *when* and *field conditions* that contextualize patterns revealed by Tarot, [[Human Design]], or Jungian psychology.

## Temporal Frameworks: Cycles and Timing

Unlike [[Human Design]] (which reads the fixed imprint at birth) or [[The Tarot]] (which reads the *now*), astrology excels at mapping **time**:

### Transits
The current positions of planets in the sky **activate** natal chart placements. When transiting Saturn squares your natal Sun, a Saturnian test or maturation cycle begins. Transits reveal **what is ripening now**.

### Progressions
Symbolic techniques (secondary progressions, solar arc directions) that unfold the chart over time, revealing **internal development cycles**.
...
Within the [[Vibrology]] framework, **Astrology** provides the **temporal coordinate**:
