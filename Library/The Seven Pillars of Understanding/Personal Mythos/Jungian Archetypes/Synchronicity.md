...
# Synchronicity
*Meaningful Coincidence — Acausal Connecting Principle*
...
**Synchronicity** is Jung's term for **meaningful coincidences**—events that are connected not by cause-and-effect but by **shared meaning**. Synchronicities occur when an inner psychological state (thought, dream, emotion) corresponds to an outer event with no causal link between them.
...
*Expansion needed: Jung's collaboration with physicist Wolfgang Pauli, I-Ching and synchronicity, quantum physics parallels, theological implications, pathological synchronicity (over-reading).*
