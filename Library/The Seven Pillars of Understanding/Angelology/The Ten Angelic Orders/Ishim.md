---
tags: [angelology, angelic-order, ishim, ashim, malkuth, tenth-order, souls-of-fire]
system: Angelology
...
verification_notes: Davidson, Wang, Maimonides sourced via NotebookLM
category: Angelic Order
order_number: 10
order_name: Ishim/Ashim
hebrew_name: אישים / אשים
alternate_spelling: Ashim (Aishim)
translation: Souls of Fire / Flames / Men of Fire / Personages
sephirah: Malkuth
planetary: Earth/Kingdom
function: Bridge between human and angelic consciousness; mediate prophetic vision
human_faculty: Sanctified humanity, prophetic consciousness
hd_center: Sacral Center (embodied spiritual power)
---

# Ishim
*Souls of Fire — The Tenth Angelic Order (Malkuth)*
...
|---------------|-------------------|
| **Order Number** | 10 (lowest order, completing the Tree) |
| **Hebrew Name** | Ishim (אישים) — "Men, Personages" |
| **Alternate Name** | Ashim (אשים) — "Flames, Souls of Fire" |
| **Translation** | "Men of Fire" or "Flames" |
| **Sephirah** | [[Malkuth]] (Kingdom/Earth) — The Tenth Emanation |
| **Divine Name** | Adonai ha-Aretz (אדני הארץ) — "Lord of Earth" |
| **Archangel** | [[Sandalphon]] (Prince of Prayer) |
| | [[Metatron]] (in some traditions) |
| | Nephesch ha Messiah (Soul of the Reconciler) (Wang) |
| **Element** | Earth (spirit materialized) |
| **Color (Atziluth)** | Yellow |
| **Color (Briah)** | Citrine, olive, russet, black |
| **Color (Yetzirah)** | Citrine, olive, russet, black (flecked gold) |
...
The tension between **Ishim** and **Ashim** is not a scribal error but a **theological paradox**:
...
The Ishim hold these opposites in balance. They are the order that proves **matter can be spiritualized** and **spirit can be embodied** without either principle being annihilated. This is the great work of Malkuth: not the escape from materiality (which would be Gnostic dualism), but the **redemption of matter through conscious presence**.

In Jungian terms, the Ishim represent the **integration of opposites**—the coniunctio oppositorum, the sacred marriage of spirit and flesh that produces the **individuated Self**. They are living proof that the goal of spiritual work is not to abandon the body, but to **illuminate it from within**.
...
Dionysus's nine-fold system reflects the **Christian emphasis on transcendence**—the angels as mediators *above* humanity, drawing souls upward toward God. The Qabalistic ten-fold system includes **immanence**—God's presence *within* the material world. The Ishim represent this immanent dimension: they are not above us, calling us upward, but *among us*, demonstrating that **the Kingdom of Heaven is here**, in Malkuth, when perceived rightly.
...
This is their defining function: **prophetic mediation**. The Ishim are the interface between the human intellect and the divine realm. When a prophet receives a vision—when Moses sees the burning bush, or Ezekiel beholds the Merkabah, or Isaiah witnesses the throne room—it is through the **ministry of the Ishim** that these visions are formed and transmitted.

They do not speak *instead of* God (which would be mediumship), nor do they speak *about* God (which would be commentary). They **make God's communication intelligible** to the human mind by translating infinite divine light into symbolic images, narratives, and words that consciousness can receive without being annihilated.

This is a subtle but crucial theological point: **prophecy is not direct divine dictation**. It is a **collaborative act** between the human soul (which must be prepared, purified, and receptive) and the angelic mediators (the Ishim) who shape the transmission according to the prophet's cultural and psychological framework. The message is divine, but the *form* it takes is mediated through the Ishim.
...
This passage suggests a **dynamic relationship between humanity and angelhood**. The Ishim are not a separate species created ex nihilo, but the **culmination of human spiritual evolution**—righteous souls who have completed the work of incarnation and now serve as angelic ministers within Malkuth.

Jewish tradition names specific figures elevated to this status:
- **Enoch**, who "walked with God" and was transformed into the Archangel [[Metatron]]
- **Elijah**, taken up in a chariot of fire without tasting death
- The **Patriarchs** (Abraham, Isaac, Jacob)
- The **Prophets** (Moses, Isaiah, Ezekiel)
- The **Righteous** (Tzaddikim) of every generation

The Ishim, then, are not distant cosmic entities but **exemplars of human potential**—proof that the soul can be refined through spiritual practice, moral excellence, and devotional surrender until it becomes a **vessel for divine light** indistinguishable from the angels created at the beginning of time.

This has profound implications: **we are not praying to alien intelligences, but to our own future**. The gap between human and angel is not ontological but developmental. The Ishim demonstrate that consciousness itself is the ladder between heaven and earth.
...
- [[Malkuth]] — The Sephirah governed by the Ishim
- [[Sandalphon]] — The Archangel of Malkuth, Prince of Prayer
- [[Metatron]] — Twin of Sandalphon; human (Enoch) elevated to Archangel
- [[The Ten Angelic Orders]] — Complete hierarchical structure
- [[The Celestial Hierarchy]] — Dionysian nine-fold system
- [[Angels]] — The ninth order (Yesod), just above the Ishim in emanation
