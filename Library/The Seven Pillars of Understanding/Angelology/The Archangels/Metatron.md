...
hebrew_name: מטטרון
meaning: Beside the Throne / Chancellor of Heaven
sephirah: Kether
...
> *"I am Enoch the son of Jared. When the generation of the Flood sinned and turned to evil deeds, the Holy One, blessed be He, removed me from their midst to be a witness against them in the heavenly height... And the Holy One, blessed be He, laid His hand upon me and blessed me with 1,365,000 blessings. He made me great and increased me until I matched the world in length and breadth. He made me seventy-two wings... and called my name **'The Lesser YHVH.'**"* (3 Enoch 4-10, paraphrased)

Enoch, the seventh patriarch from Adam (Genesis 5:21-24), is described as one who "walked with God" for 365 years—a number representing the solar year, suggesting his alignment with cosmic order. His translation into Metatron represents the **supreme individuation**—the human soul so purified, so aligned with divine will, that it transcends mortality entirely and is absorbed into the angelic hierarchy at its highest station.
...
|---------------|-------------------|
| **Name** | Metatron |
| **Hebrew** | מטטרון (*Metatron* or *Mettatron*) |
| **Meaning** | "Beside the Throne" / "Chancellor of Heaven" / "One Who Serves Behind the Throne" |
| **Alternate Titles** | The Lesser YHVH, Prince of Countenances (*Sar ha-Panim*), Chancellor of Heaven, Angel of the Presence, The Great Scribe |
| **Sephirah Overseen** | [[Kether]] (Crown) — The first emanation, divine unity, the Ancient of Days |
| **Planetary Sphere** | Primum Mobile (First Swirling) — The outermost celestial sphere, source of all motion |
| **Element** | Spirit (Root of Fire) — Primal creative spark, undifferentiated divine will |
| **Color (Atziluth)** | White Brilliance (undifferentiated light) |
| **Color (Briah)** | White Brilliance |
| **Color (Yetzirah)** | White Brilliance |
...
| **Jungian** | The Self in its highest aspect, the imago Dei, the God-image within the psyche |
| **Direction** | Above (Zenith) — Beyond the four directions, the vertical axis toward transcendence |
| **Day of Week** | Beyond days (eternal present, Sabbath consciousness) |
...
---
## Qabalistic Attribution: Kether and the Primum Mobile
...
> *"Eheieh Asher Eheieh"* — "I Am That I Am" or "I Will Be What I Will Be."

This is the name of **pure being**, existence without attributes. It is the answer to the question *"What is God?"* with the response: **"I Am."** Not "I am this" or "I am that," but simply **"I Am."**

Metatron, as the Archangel of Kether, embodies this name. To encounter Metatron is to encounter the **"I Am"** at the core of your own being—the consciousness that exists before thought, before identity, before form.

### The Four Worlds: Metatron's Function Across Dimensions

In the Qabalistic schema of the **Four Worlds**, Metatron operates across all levels:

**1. Atziluth (Emanation) — The Archetypal World**
Metatron exists as the **principle of divine presence**, the eternal template of the God-in-form. In Atziluth, Metatron is not a "being" but a **function**: the function of translating infinite unity into knowable presence.

**2. Briah (Creation) — The Archangelic World**
Metatron exists as a **distinct intelligence**, the Chancellor of Heaven, the first individuated consciousness. Here he is personal, relatable, invokable—though still beyond ordinary comprehension.

**3. Yetzirah (Formation) — The Angelic World**
Metatron appears in visions, dreams, and mystical experiences as a **figure of light**, the Guide who leads initiates through the Hekhalot (the heavenly palaces). Here he may take quasi-human form, though radiant and overwhelming.

**4. Assiah (Action) — The Material World**
Metatron manifests through **synchronicities, epiphanies, and the experience of pure presence**. He is felt in moments of mystical union, in the sudden knowing of "I Am," in the dissolution of the separate self during deep meditation or near-death experiences.

### The Pillar of Equilibrium

Kether sits at the **apex of the Middle Pillar** (the Pillar of Equilibrium), directly above Tiphareth (Beauty/the Self) and Yesod (Foundation/the Astral). The Middle Pillar represents the **path of consciousness**—the journey of the soul from Malkuth (material existence) to Kether (divine union).

Metatron, as the guardian of Kether, is the **final teacher** on this path. He is the one who says: *"You have come far. You have integrated the Shadow, embraced the Anima/Animus, awakened the Self. Now you must surrender even that. You must die to who you have become, so that you can know who you always were."*
...
---
## Metatron in Mystical and Esoteric Tradition
...
**3. The Crown**
Metatron may be depicted wearing a **crown of light**, representing Kether. Sometimes the crown bears the Tetragrammaton (יהוה) in Hebrew letters, signifying that the Name is *within* him.

**4. The Book or Scroll**
...
**The Descent of Divine Will:**
1. **Ain Soph Aur** (Limitless Light) — Pure potentiality, unmanifest
2. **Kether** (Crown) — First emanation, "I Am," divine unity
3. **Metatron** — The active intelligence that translates divine unity into knowable presence
4. **Chaioth ha-Qadesh** (Seraphim) — The angelic choir that receives and circulates the divine fire
5. **Lower Sephiroth and Angelic Orders** — Progressive densification until the divine will reaches Malkuth (material reality)
...
---
## Human Consciousness Parallel: The Head Center and Existential Pressure
...
These are Metatronic questions. They arise not from the mind (Ajna) but from a **deeper pressure**, a cosmic anxiety that propels the soul toward enlightenment. The Head Center does not seek practical answers—it seeks **truth for its own sake**, regardless of utility.

**Gate 64 (Confusion)** in the Head Center is particularly relevant: it is the pressure of the mind **before** enlightenment, the confusion that precedes clarity. The individual with Gate 64 defined feels **overwhelmed by the multiplicity of reality**, unable to make sense of it all. This confusion is **sacred**—it is the dark night that precedes the dawn, the chaos before the order.

Metatron's teaching to Gate 64 is: *"Stop trying to figure it out. You cannot think your way to God. Surrender the need to know, and you will Know."*
...
---
## The Tarot: The Fool, The Four Aces, and Judgment
...
---
## Element: Spirit (Root of Fire) — The Undifferentiated Creative Spark
...
---
## Planetary Correspondence: Primum Mobile (The First Swirling)
...
**Greek Mythology:**
- **Heracles (Hercules):** After completing the Twelve Labors and enduring his death, Heracles ascends to Olympus and becomes a god, marrying Hebe (Youth). This is apotheosis through ordeal and service.

**Hindu Tradition:**
- **The Avatars:** Beings like Rama and Krishna are divine incarnations, but the concept of **jivan-mukta** (liberated while living) also parallels Metatron—souls who achieve moksha (liberation) while still embodied, becoming living conduits of Brahman.

**Buddhist Tradition:**
- **The Bodhisattva:** The enlightened being who chooses to remain in the cycle of rebirth to aid others, embodying divine compassion while retaining connection to the human realm.

**Christian Mysticism:**
- **Theosis (Deification):** The Eastern Orthodox teaching that humans are called to become "partakers of the divine nature" (2 Peter 1:4). Metatron is the ultimate exemplar of theosis—human nature elevated to divine status.
...
**2. Study Sacred Geometry (Metatron's Cube)**
Obtain a diagram of Metatron's Cube. Meditate on it. Trace its lines with your finger or your gaze. Contemplate: *"This is the blueprint of all creation. This pattern exists within me, as me, around me."*

**3. Work the Middle Pillar (Qabalistic Exercise)**
Visualize the Middle Pillar of the Tree of Life running through your body:
- **Kether** (Crown) — White brilliance above your head
- **Daath** (Abyss) — Emptiness at your throat
- **Tiphareth** (Heart) — Golden sun at your heart
- **Yesod** (Foundation) — Silver moon at your pelvis
- **Malkuth** (Kingdom) — Earth beneath your feet

Breathe light from Kether down to Malkuth, and from Malkuth back up to Kether. Invoke Metatron at the Crown: *"Let the light descend and ascend. Let me be the pillar through which heaven and earth meet."*

**4. Contemplate Enoch's Translation**
Read Genesis 5:24 slowly. Ask: *"What does it mean to 'walk with God'? How does one live in such alignment that transformation becomes inevitable?"* Journal your reflections.
...
---
## The Gift of Integration: Living Presence and Divine Witness

When Metatronic intelligence is integrated (not identified with, but participated in), the individual becomes:

**1. A Living Presence**
The separate self dissolves, but **awareness remains**. The individual becomes a **hollow bone** through which the Divine flows. They do not claim authority—they simply *are* the presence of the sacred.

**2. A Bridge Between Worlds**
Like Metatron himself, the integrated soul becomes a **mediator**—someone who can translate the highest truths into language and action that others can receive. Teachers, mystics, prophets often carry this function.

**3. Egoless Service**
There is no "doer"—only doing. The individual acts, speaks, creates, but there is no attachment to outcome, no pride in accomplishment. It is **pure function**, like a river flowing downhill.

**4. The Witness**
The soul becomes a **witness** to its own life and the lives of others—not judging, not interfering, but **seeing clearly**. This is the Akashic function within consciousness: perfect memory, perfect presence.
...
---
## Metatron and the Other Archangels
...
## A Closing Meditation on Metatron
